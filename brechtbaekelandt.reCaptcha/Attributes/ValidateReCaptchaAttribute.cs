...
using brechtbaekelandt.reCaptcha.Services;
using Microsoft.AspNetCore.Mvc.Filters;

namespace brechtbaekelandt.reCaptcha.Attributes
{
    public class ValidateReCaptchaAttribute : ActionFilterAttribute
    {
        ...
        {
            var captchaResponse = context.HttpContext.Request.HasFormContentType && context.HttpContext.Request.Form[this._recaptchaResponseKey].Any() ? context.HttpContext.Request.Form[this._recaptchaResponseKey].First() : context.HttpContext.Request.Headers[this._recaptchaResponseKey].Any() ? context.HttpContext.Request.Headers[this._recaptchaResponseKey].ToString() : context.HttpContext.Request.Cookies[this._recaptchaResponseKey].Any() ? context.HttpContext.Request.Cookies[this._recaptchaResponseKey] : string.Empty;
